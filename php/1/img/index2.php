        ...
        $flag = false;
                ...
                && isset($_POST['email']))
            {
                if(filter_var($_POST['email'],  FILTER_VALIDATE_EMAIL))
                {
                    ...
                    else $errLogin = '<br> Введите логин';
                }
                else $errEmail = '<br>Вы ввели некоректный email';
                                ...
                                $errMiddlename = 'Введите не более 25 символов';
                                ...
                                else if($_POST['password'] != $_POST['pass_again'])
                                    {
                                    ...
                                    else if(strlen($_POST['password'])>15 || strlen($_POST['password'])<4)
                                        {
                                            ...
                                            {
                                                error_reporting(0);
                                                if ($_REQUEST['denb'] !== $_REQUEST['errorOp'])
                                                    $errorOp = 'Введите день';
                                                elseif($_REQUEST['mesyac'] !== $_REQUEST['errorOp1'])
                                                        $errorOp1 = 'Введите месяц';
                                                    elseif($_REQUEST['god'] !== $_REQUEST['errorOp2'])
                                                            $errorOp2 = 'Введите год';
                ...
                <div class="polya">
                    ...
                    <div class="edin">
                        <div class="spanright">
                            ...
                            <span><?php if(isset($errMiddlename)) echo $errMiddlename;?></span>
                        </div>
                    ...
                    <div class="edin">
                        ...
                        <div class="spanleft" >Дата рождения&nbsp;<span class="error" title="Обязательное поле для заполнения">*&nbsp;</span></div>
                        <span class="clear_dva"></span>
                    </div>
                    <div class="edin">
                        <div class="spanright">
